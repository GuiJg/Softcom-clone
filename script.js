  ...
  window.addEventListener("scroll", function () {
    ...
    if (window.scrollY > 0) {
      ...
      document.querySelectorAll(".header-proposta")[2].style.color = "#fff"
      document.querySelectorAll(".icon-proposta")[0].style.filter = "none"
      document.querySelectorAll(".icon-proposta")[1].style.filter = "none"
      document.querySelectorAll(".icon-proposta")[2].style.filter = "none"
    } else {
      ...
      document.querySelectorAll(".header-proposta")[2].style.color = "#000"
      ...
      document.querySelectorAll(".icon-proposta")[2].style.filter = "brightness(0%)"
